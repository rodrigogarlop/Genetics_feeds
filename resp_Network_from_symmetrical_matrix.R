...
# Internally: 
#  df <- as.matrix(read.table("/home/rod/Documents/02_Collaborations/Geneticas/03_corr_tables/genetics_lvlOTU-I_grp_A-corr_spearman_rows_maxpval_0.05.tsv", sep="\t",header=T, skip=0, comment.char='',quote="",fill=F, row.names=1, check.names=F))
